# applications/dashboard/apps.py

"""
Módulo de configuración de la aplicación 'dashboard'.

Este archivo define la clase de configuración `DashboardConfig`, la cual es utilizada
por Django para identificar, cargar y configurar la aplicación de panel de control
...
class DashboardConfig(AppConfig):
    """
    Clase de configuración para la aplicación 'dashboard'.
